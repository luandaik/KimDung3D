...
function XiaKeExchangeManager:openEquipChangeLayer(fightType,roleList)
    local layer  = require("lua.logic.role_new.RoleEquipChangeLayer"):new(fightType)
	layer:setRoleList(roleList)
