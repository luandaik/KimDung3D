...
function BaseLayer:onShow()
    print("open----onShow--------->",self.__cname)
    for layer in self.childArr:iterator() do
...
function BaseLayer:removeLayer(layer, isDispose)
    ...
    if layer.parentPanel then
        ...
        if (layer.___generalHead_ and layer.___generalHead_.__cname == "GeneralHead") then
            layer.___generalHead_:removeEvents()
        end
