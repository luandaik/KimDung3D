...
-- 			return EnumFightSkillType.type_12
-- 		end
-- 	end
...
-- 		if role:IsLive() and role:GetSummoned() == 0 and role:HaveForbidAttackBuff() == false and role.haveAttack == false then
...
-- 				targetInfo[i].hurt = targetInfo[i].hurt +  effectValue.value*(targetRole.maxhp)
-- 			end
