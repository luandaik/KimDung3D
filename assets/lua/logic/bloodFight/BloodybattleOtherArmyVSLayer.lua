...
function BloodybattleOtherArmyVSLayer:onShow()
    ...
    Public:addZhenFaIconForArmy(self.panel_left, EnumFightStrategyType.StrategyType_BLOOY)
end
...
function BloodybattleOtherArmyVSLayer:drawInspire()
    ...
    local totalPower = AssistFightManager:getStrategyPower(EnumFightStrategyType.StrategyType_BLOOY)
...
function BloodybattleOtherArmyVSLayer:onClickHandleForTrustLayer()
