...
function ReplyLayer:setType(type,isadd)
    ...
    if self.type == EnumRecoverableResType.PEAK then
        self.txt_title:setText(isadd and localizable.LunJianFeng_txt1 or localizable.LunJianFeng_txt2 );
        self.txt_content:setText(stringUtils.format(localizable.LunJianFeng_txt3, self.need))

        self.txt_des:setText(stringUtils.format(localizable.youli_text7, maxBuyTime - timesInfo.todayBuyTime))
        self.txt_des:setColor(ccc3(0,   0,   0));
    end

    if self.type == EnumRecoverableResType.XILING then
        self.txt_title:setText(isadd and localizable.replayLayer_buy_xiling or localizable.replayLayer_no_xiling )
        self.txt_content:setText(stringUtils.format(localizable.replayLayer_buy_xiling_tips,self.need,amount))
        self.txt_des:setText(stringUtils.format(localizable.replayLayer_today_left_times,maxBuyTime - timesInfo.todayBuyTime))
        self.txt_des:setColor(ccc3(0,   0,   0));
    end
    
    if self.type == EnumRecoverableResType.JIAYUAN_ZHUANPAN then
        self.txt_title:setText(isadd and localizable.replayLayer_buy_jiayuan_zhuanpan or localizable.replayLayer_no_jiayuan_zhuanpan )
        self.txt_content:setText(stringUtils.format(localizable.replayLayer_buy_jiayuan_zhuanpan_tips,self.need,amount))
        self.txt_des:setText(stringUtils.format(localizable.replayLayer_today_left_times,maxBuyTime - timesInfo.todayBuyTime))
        self.txt_des:setColor(ccc3(0,   0,   0));
    end

    if self.type == EnumRecoverableResType.JIAYUAN_SHARE then
        self.txt_title:setText(isadd and localizable.replayLayer_buy_jiayuan_share or localizable.replayLayer_no_jiayuan_share )
        self.txt_content:setText(stringUtils.format(localizable.replayLayer_buy_jiayuan_share_tips,self.need,amount))
        self.txt_des:setText(stringUtils.format(localizable.replayLayer_today_left_times,maxBuyTime - timesInfo.todayBuyTime))
        self.txt_des:setColor(ccc3(0,   0,   0));
    end

    if self.type == EnumRecoverableResType.JIAYUAN_INVITE then
        self.txt_title:setText(isadd and localizable.replayLayer_buy_jiayuan_invite or localizable.replayLayer_no_jiayuan_invite )
        self.txt_content:setText(stringUtils.format(localizable.replayLayer_buy_jiayuan_invite_tips,self.need,amount))
        self.txt_des:setText(stringUtils.format(localizable.replayLayer_today_left_times,maxBuyTime - timesInfo.todayBuyTime))
        self.txt_des:setColor(ccc3(0,   0,   0));
    end

    if self.type == EnumRecoverableResType.HERO then
        --self.txt_title:setText(isadd and "购买体力" or "体力不足" );
        self.txt_title:setText(isadd and localizable.replayLayer_buy_tili or localizable.replayLayer_no_tili );
        --self.txt_content:setText("是否花费" .. self.need .. "元宝购买" .. amount .. "点体力？" );
        self.txt_content:setText(stringUtils.format(localizable.replayLayer_buy_tili_tips,self.need,amount))
    ...
    if self.type == EnumRecoverableResType.SPECIAL_QI then
        self.txt_title:setText(isadd and localizable.replayLayer_buy_Qi or localizable.replayLayer_no_Qi )
        self.txt_content:setText(stringUtils.format(localizable.replayLayer_buy_Qi_tips,self.need,amount))
        self.txt_des:setText(stringUtils.format(localizable.replayLayer_today_left_times,maxBuyTime - timesInfo.todayBuyTime))
        self.txt_des:setColor(ccc3(0,   0,   0));
    end
end
