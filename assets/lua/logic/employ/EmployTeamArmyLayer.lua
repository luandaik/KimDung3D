...
EmployTeamArmyLayer.LIST_ITEM_HEIGHT = 200; 
...
function EmployTeamArmyLayer:refreshUI()
    ...
    if not self.table_select then
        ...
        self.roleList = ZhengbaManager:getSortStrategy(self.fightType, self.currSortType, nil)
