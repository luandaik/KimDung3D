...
function HoushanLayer:loadData(chapterIndex)
    ...
    self:refreshMissionList(chapterIndex)
end

function HoushanLayer:refreshMissionList(pageIndex)
...
function HoushanLayer:showInfoForPage(pageIndex)
    ...
    self:showUIData(pageIndex)
end

--显示UI数据
function HoushanLayer:showUIData(pageIndex)
    -- body
...
function HoushanLayer:registerEvents()
    ...
    self.updateHoushanCallBack = function(event)
        ...
        self:showUIData(self.selectIndex)
    end;
