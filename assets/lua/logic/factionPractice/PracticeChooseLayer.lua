...
function PracticeChooseLayer:cellInfoSet(panel, idx)
    ...
    elseif self.currBtnIndex == 3 then
        currSkillType = GuildPracticeData:getGuildPracticeTypeNum(3,1)
        currSkillType = currSkillType+ (self.currBtnIndex * 3) + idx - 1
    end
    ...
    if self.currBtnIndex == 2 then
        skillpic:setVisible(true)
        skillKuang:setTexture("ui_new/faction/xiulian/img_kuang.png")
    ...
    if level >= maxstudylevel then
        ...
        if self.currBtnIndex == 2 or self.currBtnIndex == 3 then
...
function PracticeChooseLayer.onExchangeButtonClick(sender)
    ...
    filterlist:pushBack(self.chooseCardRole.id)
