...
local btnPageTexture = {
    ...
    {
        imgSelect = "ui_new/faction/xiulian/btn_nl2.png",
        imgNormal = "ui_new/faction/xiulian/btn_nl1.png",
    },
}

local cellDetailData = {}
local cellDetailDataSencond = {}
local cellDetailDataThird = {}
--[[
    -inheritId
    -inheritName
    -inheritIcon
...
function PracticeInherit.numberOfCellsInTableView(table)
    ...
    elseif self.currBtnIndex == 3 then
        count = #cellDetailDataThird
    end
    ...
    elseif (self.currBtnIndex == 1 and #cellDetailData == 0) or (self.currBtnIndex == 2 and #cellDetailDataSencond == 0) or (self.currBtnIndex == 3 and #cellDetailDataThird == 0) then         
        self.noHerit:setVisible(true)
...
function PracticeInherit:cellInfoSet(cell, panel, idx)
    ...
    if not cell.boundData then
        ...
        cell.img_kuang = TFDirector:getChildByPath(panel, 'img_kuang')
    ...
    elseif self.currBtnIndex == 3 then
        dataInfo = cellDetailDataThird[idx]
    end

    if self.currBtnIndex == 2 then
        cell.img_kuang:setTexture("ui_new/faction/xiulian/img_kuang.png")
    else
        cell.img_kuang:setTexture("")
    end
--[[
    -inheritId
    -inheritName
...
function PracticeInherit.onHeadBtnClick( btn )
    ...
    for k,v in pairs(GmIDTblData) do
        ...
        if cardRole then
            filter_list:pushBack(cardRole.id)
        end
    end
            ...
            for attrType,attrLevel in pairs(tblListA) do
                ...
                if attrLevel > LevelB then
                    ...
                    if templeteDataA then
                        ...
                        elseif templeteDataA.page == 2 then
                            table.insert(cellDetailDataSencond, itemData)
                        else
                            table.insert(cellDetailDataThird, itemData)
                        end                        
                    end
                end
            end
...
function PracticeInherit.onXiuLianBtnClick(btn)
    ...
    elseif self.currBtnIndex == 3 then
        dataInfo = cellDetailDataThird[btn.idx]
    end
...
function PracticeInherit:refreshArrowBtn()
    ...
    if self.TabView then
        ...
        elseif self.currBtnIndex == 3 then
            guildPracticeNum = #cellDetailDataThird
        end
