...
function FactionRecordNew:setCellData(panel,idx, showTime)
    ...
    if defInfo then
        ...
        Public:addInfoListen(defheadIcon,true,3,itemData.defPlayerId)
...
function FactionRecordNew:refreshGuildInfo()
    ...
    if atkGuildData and atkGuildData.name then
        ...
        --     self.atkPanel_Buff:setVisible(true)
    ...
    if defGuildData and defGuildData.name then
        ...
        --     self.defPanel_Buff:setVisible(true)
...
function FactionRecordNew.btnBuffClick( btn )
