...
function RoleFireLayer.XiaHunClickHandle(sender)
    ...
    AutoTestManager:addAutoTestName(self.tableView, "soulListLen_"..self.soulList:length())
end
function RoleFireLayer.XiaKeClickHandle(sender)
    ...
    AutoTestManager:addAutoTestName(self.tableView, "roleListLen_"..self.roleList:length())
end
    ...
    if self.selectType == 1 then
        for i=1,numInCell do
            ...
            if (idx * numInCell + i) <= self.roleList:length() then
                AutoTestManager:addAutoTestName(cell.equip_panel[i].panel_empty, "panel_empty_"..index)
                AutoTestManager:addAutoTestName(cell.equip_panel[i].panel_info, "panel_info_"..index)
                ...
                AutoTestManager:addAutoTestName(cell.equip_panel[i].panel_empty, "panel_empty_")
                AutoTestManager:addAutoTestName(cell.equip_panel[i].panel_info, "panel_info_")
                cell.equip_panel[i].panel_empty:setVisible(true);
