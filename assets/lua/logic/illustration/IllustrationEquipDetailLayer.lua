...
function IllustrationEquipDetailLayer:initUI(ui)
    ...
    local txt_des           = TFDirector:getChildByPath(ui, 'txt_des')
    ...
    self.txt_des            = Public:createRichtextHB(txt_des, "", EnumRichtextType.ShopOrUse)
    -- 基础武力
...
function IllustrationEquipDetailLayer:draw()
    ...
    self.txt_des:setText(stringUtils.richText(equipMentData.details))
