...
local IllustrationZhenfaLayer = class("IllustrationZhenfaLayer", BaseLayer)

function IllustrationZhenfaLayer:ctor()
...
function IllustrationZhenfaLayer:initUI(ui)
    ...
    self.QualityRes = {}
    self.QualityRes[5] = "ui_new/handbook/zhenfa_3.png"
    self.QualityRes[4] = "ui_new/handbook/zhenfa_2.png"
    self.QualityRes[3] = "ui_new/handbook/zhenfa_1.png"
...
function IllustrationZhenfaLayer:removeUI()
    self.super.removeUI(self)
end

function IllustrationZhenfaLayer:registerEvents()
...
function IllustrationZhenfaLayer:removeEvents()
    --按钮事件
...
-- index 对应职业 0为全部
function IllustrationZhenfaLayer:FilterRoleListData(kind)
	self.qualityZhenfaList = {}

	self.qualityZhenfaList = IllustrationManager:getZhenfaList()
	self.qualityNumList  = IllustrationManager:CountNumInList(self.qualityZhenfaList)
	...
	-- print("num1 = ", #self.qualityZhenfaList[1])
	-- print("num2 = ", #self.qualityZhenfaList[2])
	-- print("num3 = ", #self.qualityZhenfaList[3])
	-- print("num4 = ", #self.qualityZhenfaList[4])
end


function IllustrationZhenfaLayer:drawCellTitle(cell, QualityIndex, curNum, totalNum)
...
function IllustrationZhenfaLayer:drawRole(node, quality, index)
...
function IllustrationZhenfaLayer:drawCellDetail(cell, quality, index, num)
	-- 绘制背景
    local rowTotal = math.ceil(num/5)
...
function IllustrationZhenfaLayer:drawCellWithIndex(cell, cellIndex)
    -- 对cellindex区域
...
function IllustrationZhenfaLayer:drawRoleList()
    ...
    tableView:addMEListener(TFTABLEVIEW_SIZEFORINDEX, IllustrationZhenfaLayer.cellSizeForTable)
    tableView:addMEListener(TFTABLEVIEW_SIZEATINDEX, IllustrationZhenfaLayer.tableCellAtIndex)
    tableView:addMEListener(TFTABLEVIEW_NUMOFCELLSINTABLEVIEW, IllustrationZhenfaLayer.numberOfCellsInTableView)
...
function IllustrationZhenfaLayer.numberOfCellsInTableView(table)
	local self = table.logic
    return self.TableCellNum
end

function IllustrationZhenfaLayer.cellSizeForTable(table,idx)
    local self = table.logic
...
function IllustrationZhenfaLayer.tableCellAtIndex(table, idx)
...
function IllustrationZhenfaLayer:drawDefault(index)
...
function IllustrationZhenfaLayer.BtnClickHandle(sender)
...
function IllustrationZhenfaLayer.touchRoleNode(sender)
    local self      = sender.logic
    local index     = sender.index
...
-- -----断线重连支持方法
-- function IllustrationZhenfaLayer:onShow()
    
-- end

-- function IllustrationZhenfaLayer:dispose()

-- end

return IllustrationZhenfaLayer