...
function IconTableView:initTableView(ui)
    ...
    AutoTestManager:addAutoTestName(self.tableView, "tableViewLen_"..#self.iconList)
end
    ...
    for i=1,self.column do
        ...
        if cell.pzImg[i] and tmpIndex <= #(self.iconList) then
            ...
            if iconId and iconId > 0 then
                AutoTestManager:addAutoTestName(cell.nodes[i], "HeadCell_"..tmpIndex)
                ...
                AutoTestManager:addAutoTestName(cell.nodes[i], "HeadCell")
