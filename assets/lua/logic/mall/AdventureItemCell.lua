...
function AdventureItemCell:setData(type,data)
	...
	--周年庆天书做特殊处理
	if (self.commodityData.consume_id == 30906) then
		self.type = HeadResType.ZNQBCY
	end
	self.img_res_icon:setTexture(GetResourceIconForGeneralHead(self.type, self.commodityData.consume_id))
