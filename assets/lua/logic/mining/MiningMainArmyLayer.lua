...
function MiningMainArmyLayer:refreshUI()
    ...
    if not self.table_select then
        ...
        ZhengbaManager:reSortStrategy(self.fightType, CardRoleManager.cardRoleList, self.currSortType)
...
function MiningMainArmyLayer.tableCellAtIndex(tableView, idx)
    ...
    for i=1,3 do
        ...
        local roleId = CardRoleManager.cardRoleList:objectAt(roleIndex);
