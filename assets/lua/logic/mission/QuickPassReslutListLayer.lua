...
function QuickPassReslutListLayer:initUI(ui)
    ...
    self.lb_tuandui:setVisible(false)
...
function QuickPassReslutListLayer:loadRewardList()
                    ...
                    onComplete = function()
                        ...
                        if rewardIndex < #reslut_nodeArr[index].reward_itemArr then
                            ...
                            if index <= #self.itemlist then
                                ...
                                self.lb_tuandui:setVisible(true)
                                if self.endingeffect ==nil then
                                    ...
                                    endingeffect:addMEListener(TFARMATURE_COMPLETE,function()
                                        ...
                                        endeffect:setPosition(ccp(self:getSize().width/2 - 2 ,self:getSize().height/2 + 39))
    ...
    sumingeffect:setPosition(ccp(self.img_card:getSize().width/2 - 197 ,self.img_card:getSize().height/2+38))
...
function QuickPassReslutListLayer:removeEvents()
    ...
    self.super.removeEvents(self)
       ...
       --删除的时候 弹出游方商人
    if MallManager.travelBusiness and MallManager.travelBusiness.info and MallManager.travelBusiness.beginTime and MallManager.travelBusiness.endTime  and MallManager.bYouFangSweep then
        ...
        if nowTime >= MallManager.travelBusiness.beginTime and nowTime <= MallManager.travelBusiness.endTime then
            ...
            MallManager.bYouFangSweep = false
        end
    end
    ...
    RewardManager:setStopGodDropShow(false)
end
