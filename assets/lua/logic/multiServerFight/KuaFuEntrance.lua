...
function KuaFuEntrance:onShow()
    ...
    if state == MultiServerFightManager.ActivityState_2 or MultiServerFightManager.ActivityState_4 == state then
    	self.icon_battletime[1]:setVisible(true)
    elseif state >= MultiServerFightManager.ActivityState_5 or state <= MultiServerFightManager.ActivityState_8 then
...
function KuaFuEntrance.onRuleClick( sender )
