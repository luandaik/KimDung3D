...
function PayResultLayer:initUI(ui)
    ...
    self.txt_hasIntegral       = TFDirector:getChildByPath(TFDirector:getChildByPath(ui, 'Panel_guibing'), 'txt_num')
...
function PayResultLayer:refreshUI()
    ...
    self.txt_hasIntegral:setText(self.baseValue)
end
...
function PayResultLayer:tryExecuteCloseCallback()
...
function PayResultLayer:setCloseCallback(callbackFunc)
