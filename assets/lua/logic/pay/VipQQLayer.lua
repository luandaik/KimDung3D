...
function VipQQLayer:initUI(ui)
    ...
    for i=1,4 do
        -- self.rightList[i] = {}
        self.rightList[i] = TFDirector:getChildByPath(ui, 'effect_'..i)
...
--添加特效
function VipQQLayer:addEffect()
    for i=1,4 do
        TFResourceHelper:instance():addArmatureFromJsonFile("effect/guibin.xml")   
        local showeffect = TFArmature:create("guibin_anim")
        ...
        showeffect:setScale(3.8)
        self.rightList[i]:addChild(showeffect)        
