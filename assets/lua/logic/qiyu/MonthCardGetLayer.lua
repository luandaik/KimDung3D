...
function MonthCardGetLayer:Draw()
    ...
    -- local tmpDateTab = GetCorrectDate('*t',QiyuManager.ContractInfo.lastGotRewardTime/1000)
    -- local lastRewardDayIndex    = tmpDateTab.yday
    -- tmpDateTab = GetCorrectDate('*t',QiyuManager.ContractInfo.endTime/1000)
    -- local endDayIndex           = tmpDateTab.yday
    -- tmpDateTab = GetCorrectDate('*t',nowTime)
    ...
    -- local tab = GetCorrectDate("*t", nowTime)
