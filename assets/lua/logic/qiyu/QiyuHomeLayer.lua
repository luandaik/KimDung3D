...
function QiyuHomeLayer:InitQiyuList()
    ...
    --家园
    self.qiyuTmpList[QiYuType.JiaYuan] = {}
    self.qiyuTmpList[QiYuType.JiaYuan].btnNormal = "ui_new/qiyu/yqm_anniu.png"
    self.qiyuTmpList[QiYuType.JiaYuan].btnSelect = "ui_new/qiyu/yqm_anniu_press.png"
    self.qiyuTmpList[QiYuType.JiaYuan].layerName = "lua.logic.qiyu.JiayuanCodeLayer"
    self.qiyuTmpList[QiYuType.JiaYuan].funId     = 900+QiYuType.JiaYuan
    ...
    self.qiyuTmpList[QiYuType.Tmall].btnNormal = "ui_new/qiyu/btn_yjdy.png"
    self.qiyuTmpList[QiYuType.Tmall].btnSelect = "ui_new/qiyu/btn_yjdy_hl.png"
    ...
    -- 角色鉴定
    self.qiyuTmpList[QiYuType.RoleIdentify] = {}
    self.qiyuTmpList[QiYuType.RoleIdentify].btnNormal = "ui_new/qiyu/identify/btn_jsjd1.png"
    self.qiyuTmpList[QiYuType.RoleIdentify].btnSelect = "ui_new/qiyu/identify/btn_jsjd2.png"
    self.qiyuTmpList[QiYuType.RoleIdentify].layerName = "lua.logic.qiyu.IdentifyBaseLayer"
    self.qiyuTmpList[QiYuType.RoleIdentify].funId     = 900+8

    --祭祀
    self.qiyuTmpList[QiYuType.Fete] = {}
    self.qiyuTmpList[QiYuType.Fete].btnNormal = "ui_new/qiyu/btn_jisi.png"
    self.qiyuTmpList[QiYuType.Fete].btnSelect = "ui_new/qiyu/btn_jisi_h.png"
    self.qiyuTmpList[QiYuType.Fete].layerName = "lua.logic.qiyu.JiSiLayer"
    self.qiyuTmpList[QiYuType.Fete].funId     = 900+9

    --答题
    self.qiyuTmpList[QiYuType.DaTi] = {}
    self.qiyuTmpList[QiYuType.DaTi].btnNormal = "ui_new/qiyu/btn_jhyj.png"
    self.qiyuTmpList[QiYuType.DaTi].btnSelect = "ui_new/qiyu/btn_jhyj_hl.png"
    self.qiyuTmpList[QiYuType.DaTi].layerName = "lua.logic.qiyu.DaTiHomeLayer"
    self.qiyuTmpList[QiYuType.DaTi].funId     = 900+QiYuType.DaTi
    -- 检测当前那些活动是开启的
    self.qiyuList = {}
    local num = 1
...
function QiyuHomeLayer:InitQiyuBtn()
    ...
    for i=1,qiyuNum do
        ...
        btn:setPosition(ccp(80+(i-1)*150, 83))
...
function QiyuHomeLayer:redraw()
    ...
    for i=1,qiyuNum do
        ...
        if qiyuInfo ~= nil then
            local index = qiyuInfo.funId - 900
            CommonManager:setRedPoint(qiyuInfo.btn, QiyuManager:isHaveRedPointWithIndex(index), "qiuyu", ccp(0, 0))
        end
    end
end
