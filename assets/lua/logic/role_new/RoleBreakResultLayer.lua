...
function RoleBreakResultLayer:setPower(oldPower,fightType)
...
function RoleBreakResultLayer:drawNowArea()
    ...
    local power = self.cardRole.power
    if self.fightType then
        power = self.cardRole:getPowerByFightType(self.fightType)
    end
    txt_power:setText(power)
