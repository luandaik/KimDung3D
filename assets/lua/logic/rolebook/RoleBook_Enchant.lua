...
function RoleBook_Enchant:refreshUI()
    ...
    local function soulcmp( soul1, soul2 )
            if soul1.type == 9 and soul1.kind == 2 then
            if soul2.type == 9 and soul2.kind == 2 then
                return soul1.quality < soul2.quality
            end
            return true
        elseif soul2.type == 9 and soul2.kind == 2 then
            return false
        else
            if soul1.quality == soul2.quality then
                if soul1.type == soul2.type then
                    return soul1.id > soul2.id
                else
                    return soul1.type > soul2.type
                end
            else
                return soul1.quality < soul2.quality
            end
    ...
    if self.bookOwnList:length() == 0 then
...
function RoleBook_Enchant:drawList()
    ...
    self.RowNum  = math.ceil(bookNum/4)
...
function RoleBook_Enchant.tableCellAtIndex(table, idx)
    ...
    if nil == cell then
        ...
        for i=1,4 do
            ...
            book_panel:setPosition(ccp((i-1)*96, 0))
