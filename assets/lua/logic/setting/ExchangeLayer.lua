...
function ExchangeLayer:initUI(ui)
    ...
    self.txt_duihuanma  = TFDirector:getChildByPath(ui, 'txt_duihuanma');
    self.txt_duihuanma:setVisible(MainPlayer:getServerSwitchStatue(ServerSwitchType.DuiHuantext))
