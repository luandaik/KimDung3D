...
function SettingLayer:initUI(ui)
    ...
    self.btn_gotoLogin:setVisible(MainPlayer:getServerSwitchStatue(ServerSwitchType.ExitBtn))
    
    -- if HeitaoSdk then
    --   if HeitaoSdk.getplatformId() == "282" then
    --       self.btn_gotoLogin:setVisible(false)
    --   else
    --       self.btn_gotoLogin:setVisible(true)
    --   end
    -- end
end
