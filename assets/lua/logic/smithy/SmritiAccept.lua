...
function SmritiAccept:initTableview()
    if self.tableView then
        ...
        tableView:addMEListener(TFTABLEVIEW_SCROLL, SmritiAccept.tableScroll)
...
function SmritiAccept.tableScroll(table)
    local self = table.logic
...
function SmritiAccept.listTypeClickHandle(sender)
    local self = sender.logic
...
function SmritiAccept.btnChoiceClickHandle(sender)
    local self = sender.logic
