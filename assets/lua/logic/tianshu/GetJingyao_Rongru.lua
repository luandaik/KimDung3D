...
function GetJingyao_Rongru:addHechengEffect()
    ...
    TFResourceHelper:instance():addArmatureFromJsonFile("effect/btn_common.xml")
    local effect = TFArmature:create("btn_common_anim")
...
function GetJingyao_Rongru.onRongruClickHandle(sender)
    ...
    -- print("mainplayer yueli = ", SkyBookManager:getCurYueli())
    -- print("need yueli = ", self.costGoodsNum)
    local enough = MainPlayer:isEnough(EnumDropType.YUELI,self.costGoodsNum)
