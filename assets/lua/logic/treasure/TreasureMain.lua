...
function TreasureMain:initCell(node,configList)
    ...
    local bg_icon = TFDirector:getChildByPath(rootNode, 'bg_icon')
...
function TreasureMain:doOverAction()
    ...
    seqArr:addObject(spawn) 
        ...
        function ()
            ...
            local delayAc = CCDelayTime:create(0.01)
            acArr:addObject(delayAc)
            acArr:addObject(callFuncN)
            self.panel_1:runAction(CCSequence:create(acArr))
...
function TreasureMain:doMulripleOverAction()
    ...
    local moveTo = CCMoveTo:create(0.5/maxTimes + 0.1,ccp(591,328))
    array:addObject(moveTo)
    local scaleTo = CCScaleTo:create(0.5/maxTimes + 0.1,1)
    array:addObject(scaleTo)  
    local spawn = CCSpawn:create(array)
    seqArr:addObject(spawn) 
        local funcall = CCCallFuncN:create(
        function ()
            ...
            local callFuncN = CCCallFuncN:create( function()
                    ...
                    print("rewardList-----mulriple---once")
