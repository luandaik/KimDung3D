...
function AdventureEnemyLayer:setCellInfo(cell,idx)
    ...
    local bg_icon = TFDirector:getChildByPath(cell, "bg_icon")
    ...
    if cell.reward_item == nil then
        ...
        reward_item:setPosition(bg_icon:getPosition())
        reward_item:setZOrder(1)
        bg_icon:getParent():addChild(reward_item)
