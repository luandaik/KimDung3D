...
ZhengbaArmyLayer.LIST_ITEM_HEIGHT = 185; 
...
function ZhengbaArmyLayer:updateStrategyBaseMsg()
    ...
    self.txt_RoleNum:setText(ZhengbaManager:getFightRoleNum( self.fightType ) .. "/" .. ZhengbaManager:getMaxNum(self.fightType));
...
function ZhengbaArmyLayer:initUI(ui)
    ...
    if self.fightType == EnumFightStrategyType.StrategyType_PVE then
        titleTexture = "ui_new/array/img_jingong.png"
    elseif self.fightType == EnumFightStrategyType.StrategyType_AREAN then
        titleTexture = "ui_new/array/img_fangshou.png"
    elseif self.fightType == EnumFightStrategyType.StrategyType_DOUBLE_1 then
        titleTexture = "ui_new/array/img_shuangzhen.png"
...
function ZhengbaArmyLayer.onSkillBtnClick( btn )
    local self = btn.logic
