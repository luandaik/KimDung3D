...
.method public static a(Landroid/content/Context;Lcom/snda/woa/af;)V
    ...
    const-string v3, "SmsInterceptAppUtil"
    ...
    invoke-static {v3, v0}, Lcom/snda/woa/au;->c(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :try_start_3
    const-string v3, "CREATE TABLE sms_intercept_app (id INTEGER PRIMARY KEY autoincrement, appPackage TEXT, appName TEXT, appVersion TEXT)"

    invoke-virtual {v1, v3}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string v3, "SmsInterceptAppUtil"

    const-string v4, "sql\uff1aCREATE TABLE sms_intercept_app (id INTEGER PRIMARY KEY autoincrement, appPackage TEXT, appName TEXT, appVersion TEXT)"
    ...
    const-string v4, "\u521b\u5efa\u8868 sms_intercept_app \u53d1\u751f\u5f02\u5e38"
    ...
    const-string v4, "\u4fdd\u5b58\u62e6\u622a\u77ed\u4fe1\u7684App\u4fe1\u606f\u53d1\u751f\u5f02\u5e38\uff1a"
